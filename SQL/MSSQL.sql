...
add FOREIGN KEY (departamento_id) REFERENCES tb_departamento(id_departamento);

alter table tb_projeto_empregado
add FOREIGN KEY (funcionario_id) REFERENCES tb_funcionarios(id_funcionario);

alter table tb_projeto_empregado
add FOREIGN KEY (projeto_id) REFERENCES tb_projetos(id_projeto);
